...
config.on_attach = function(client, bufnr)
  ...
  --set("n", "<F5>", with_compile(function()
    --local main_config_opts = {
      --verbose = false,
      --on_ready = require("jdtls.dap").continue,
    --}
...
--local bundles = {vim.fn.glob(home .. "/dev/microsoft/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-*.jar", 1)}
local bundles = {}
